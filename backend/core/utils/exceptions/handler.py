...
from core.schema.common import BaseResponse, Status

from core.utils.exceptions.errors import APIError, handle_exception
from core.utils.exceptions.logger import logger_utility
...
class ErrorHandlingMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        request.state.request_id = headers.get("X-Request-ID", str(uuid.uuid4()))
        request.state.correlation_id = headers.get(
